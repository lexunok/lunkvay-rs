...
pub fn FriendsPage() -> impl IntoView {
    ...
    let friendship_labels_resource = LocalResource::new(async move || {
        get_friendship_labels().await.unwrap_or_default()
    });

    let delete_friendship_label_action = Action::new_local(|label_value: &String| {
        let label_value = label_value.clone();
        async move {
            delete_friendship_labels_by_label_value(label_value).await
        }
    });
    ...
    Effect::new(move |_| {
        if delete_friendship_label_action.version().get() > 0 {
            friends_resource.refetch();
            friendship_labels_resource.refetch();
        }
    });
    ...
    let refetch_friends_callback = Callback::new(move |()| {
        friends_resource.refetch();
        friendship_labels_resource.refetch();
    });
                ...
                <div class=style::friends_list>
                    <For
                        ...
                        children=move |friend| {
                            view! { <FullFriendCard friend=friend refetch_friends=refetch_friends_callback/> }
                        }
                    />
                </div>
            }
    ...
    view! {
        <div class=style::friends_page>
            <div class=style::main_content>
                ...
                <div class=style::labels_section>
                    <Suspense>
                        {move || friendship_labels_resource.get().map(|labels| {
                            view! {
                                <div class=style::labels_list>
                                    <For
                                        ...
                                        key=|label| label.id
                                        children=move |label| {
                                            let label_value = label.label.clone();
                                            view! {
                                                <span class=style::label_item>
                                                    {label_value.clone()}
                                                    <button class=style::delete_label_button on:click=move |_| {
                                                        delete_friendship_label_action.dispatch(label_value.clone());
                                                    }>
                                                        "x"
                                                    </button>
                                                </span>
                                                ...
                                                view! {
                                                    <div class=style::friend_request_item>
                                                        ...
                                                        <div class=style::request_actions>
                                                            <button on:click=move |_| { accept_request_action.dispatch(friendship_id); }>
                                                            ...
                                                            <button on:click=move |_| { reject_request_action.dispatch(friendship_id); }>
                                            ...
                                            children=move |req| {
                                                ...
                                                view! {
                                                    <div class=style::friend_request_item>
                                                        ...
                                                        <div class=style::request_actions>
                                                            <button on:click=move |_| { cancel_request_action.dispatch(friendship_id); }>
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM12 10.5858L9.17157 7.75736L7.75736 9.17157L10.5858 12L7.75736 14.8284L9.17157 16.2426L12 13.4142L14.8284 16.2426L16.2426 14.8284L13.4142 12L16.2426 9.17157L14.8284 7.75736L12 10.5858Z"></path></svg>
                                                            </button>
                                                        </div>
                                                    </div>
                                            ...
                                            children=move |req| {
                                                ...
                                                view! {
                                                    <div class=style::friend_request_item>
                                                        ...
                                                        <div class=style::request_actions>
                                                            <button on:click=move |_| { send_request_action.dispatch(friendship_id); }>
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM11 11H7V13H11V17H13V13H17V11H13V7H11V11Z"></path></svg>
                                                            </button>
                                                        </div>
                                                    </div>
